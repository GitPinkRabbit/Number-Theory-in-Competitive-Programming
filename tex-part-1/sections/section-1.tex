...
\end{frame}
\begin{frame}
  \frametitle{\Cpp{} 中整型的 \texttt{/} 和 \texttt{\%} 运算符}
  \framesubtitle{“\texttt{/}”运算符的舍入方向}
...
\begin{frame}
  \frametitle{\Cpp{} 中整型的 \texttt{/} 和 \texttt{\%} 运算符}
  \framesubtitle{\textbf{代码注意事项}：整数提升和整数转换}
  在 \Cpp{} 中，整型之间的算术运算将经过两道关卡：\alert{整数提升}和\alert{整数转换}。
\end{frame}
\begin{frame}
  \frametitle{\Cpp{} 中整型的 \texttt{/} 和 \texttt{\%} 运算符}
  \framesubtitle{\textbf{代码注意事项}：整数提升}
...
\begin{frame}
  \frametitle{\Cpp{} 中整型的 \texttt{/} 和 \texttt{\%} 运算符}
  \framesubtitle{\textbf{代码注意事项}：整数转换}
